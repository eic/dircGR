...
Simulations are done inside the eic-shell, and we will run
dircGR on the output of those outside the shell. 
...
azimuthal angle is chosen for this polar angle and momentum so
...
Pick any existing event file (these have the extension hepmc3.tree.root), 
